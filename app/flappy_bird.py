...
class Passaro:
    ...
    def desenhar(self, tela):
        # definir qual imagem do passsaro usar
    ...
    while rodando:
        ...
        for cano in canos:
            for i, passaro in enumerate(passaros):
                if cano.colidir(passaro=passaro):
                    passaros.pop(i)
        ...
        desenhar_tela(tela=tela,passaros=passaros,canos=canos,chao=chao,pontos=pontos)
